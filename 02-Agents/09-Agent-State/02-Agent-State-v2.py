# langgraph_agent_state_examples.py
# This file demonstrates three examples of defining and using AgentState in LangGraph.
# Each example builds a simple graph to show how the state is used in practice.
# We'll use LangChain's tools and messages for illustration.
# Prerequisites: Install langgraph, langchain-core (pip install langgraph langchain-core)
