"""
LangChain + LangGraph Deep Research Agent (OpenAI)

A tutorial deep-research agent that:
...
Usage:
    python deep_research_agent.py "Your research question here"

Requirements:
    pip install langchain-openai langgraph langchain-community rich python-dotenv
    Set OPENAI_API_KEY in your environment or .env file.

Learning objectives:
  - Build a multi-step research workflow with LangGraph create_react_agent
  - Use DuckDuckGoSearchRun as a web search tool
  - Structure agent tools for planning, searching, and synthesis
"""
...
# ── 2. Build the LangGraph ReAct research agent ─────────────────────────────

def build_agent():
    """Create a LangGraph ReAct agent for deep research."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="LangChain + LangGraph Deep Research Agent (OpenAI)")
